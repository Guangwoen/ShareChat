<template>
  <div class="login-wrap">
    <el-form class="login-container">
      ...
      <el-alert v-if="judge" title="密码和账号不能为空" type="error" center show-icon></el-alert>
      <el-form-item label="账号">
        <el-input type="text" v-model="form.userId" placeholder="登录账号" autocomplete="off"></el-input>
      </el-form-item>
      <el-form-item label="密码">
        <el-input type="password" v-model="form.password" placeholder="登录密码" autocomplete="off"></el-input>
      </el-form-item>
      <el-form-item>
